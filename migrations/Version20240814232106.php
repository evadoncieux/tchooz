...
final class Version20240814232106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clothing_item (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE daily_weather (id INT AUTO_INCREMENT NOT NULL, temperature_id INT DEFAULT NULL, weather_type_id INT DEFAULT NULL, INDEX IDX_9331029AD9835775 (temperature_id), INDEX IDX_9331029A61736FD8 (weather_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE clothing_item_category ADD CONSTRAINT FK_7300881112469DE2 FOREIGN KEY (category_id) REFERENCES category (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE daily_weather ADD CONSTRAINT FK_9331029A61736FD8 FOREIGN KEY (weather_type_id) REFERENCES weather_type (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE weather_type');
